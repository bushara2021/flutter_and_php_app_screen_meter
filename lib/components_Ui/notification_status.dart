...
class NotificationsStatus extends StatefulWidget {
  final String idHolder;
  NotificationsStatus(this.idHolder);
  @override
...
class SecondScreen extends State<NotificationsStatus> {
  final String idHolder;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(
                title: Text('Notification meter status',
                    style: TextStyle(
                      color: Colors.white,
                    )),
                                      ...
                                      child: Padding(
                                          ...
                                          child: FutureBuilder<List<Data>>(
                                            future: fetchDataRead(
                                                'http://192.168.43.74/project/Notificationshow.php',
                                                idHolder),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        ' Date at \n ' +
                                                                            snapshot.data![index].notificationDate.toString(),
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.green,
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        ' Number                 ' +
                                                                            snapshot.data![index].notificationId.toString(),
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.white,
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        ' office             ' +
                                                                            snapshot.data![index].customerLocation,
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.white,
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        ' phone ' +
                                                                            snapshot.data![index].customerPhone.toString(),
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.white,
                                                                  ...
                                                                  Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        ' ' +
                                                                            snapshot.data![index].notificationText.toString(),
                                                                        style:
                                                                            TextStyle(
                                                                          color:
                                                                              Colors.redAccent,
